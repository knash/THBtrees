...
def limits_allhad(model, step = 0):
   ...
   parVals = mle(model, input = 'toys-asimov:0', n=1,with_error=True, with_covariance=False, signal_process_groups=signal_process_groups1,ks=True, chi2=True,options=myopts)
   parlist = ['__nll','beta_signal','__chi2','__ks']
   canvnuisanceplot = makenuisanceplot(parlist,parVals[''],"bkgONLY_std")
