...
def build_allhad_model():
	...
	print p
    	...
    	model.add_lognormal_uncertainty('topsf', math.log(1.04), p)
       	if p=='ttbar':
...
def limits_allhad(model, step = 0):
   ...
   canvnuisanceplot = makenuisanceplot(parlist,parVals['wp1500'],"bkg1500_ttsflow")
   ...
   canvnuisanceplot = makenuisanceplot(parlist,parVals['wp1500'],"sig1500_ttsflow")
   canvnuisanceplot = makenuisanceplot(parlist,parVals['wp2000'],"sig2000_ttsflow")
